...
## POC Flow
Es werden beispielhaft Bilder aus dem Archiv ausgesucht, wo zu erkennen ist, dass sich eine Person auf dem Bild befindet. Hier die drei Bilder der Stichprobe (***) mit einem Scanvorgang, sowie Ergebnis (***). Anschließend werden die Bilder im Tool hochgeladen und das Tool analysiert, ob ein Gesicht zu erkennen ist. Wenn kein Gesicht erkennbar ist, kommt eine Fehlermeldung: ,,No results".
